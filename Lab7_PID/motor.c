...
void encoder_init(void) {
    ...
    TIM6->PSC = 11; //formerly 11
    TIM6->ARR = 30000; //formerly 30_000
...
void PI_update(void) {
    ...
    uint16_t integral_previous = error_integral;
error_integral = integral_previous + (Ki * error);
...
if (error_integral > 3200){error_integral = 3200;}
    ...
    int16_t output = error_integral + Kp*error; 
